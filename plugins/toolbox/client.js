...
return {
  ...
  apply(ctx) {
    ...
    styles.insert([
      ...
      '.fl-node{max-width:520px;min-width:0;border:1px solid var(--tb-border,var(--dsw-alias-border-l1,#35363e));border-radius:8px;padding:7px 10px;display:flex;flex-direction:column;gap:3px}',
      ...
      // 入/出行：调用的传入参数与返回结果（进出关系）
      '.fl-io{display:flex;align-items:baseline;gap:5px;font-family:ui-monospace,Consolas,monospace;font-size:10.5px;line-height:1.5;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}',
      ...
      '.fl-in{color:var(--tb-text-2,var(--dsw-alias-label-secondary,#9a9ba6))}',
      '.fl-in .fl-io-tag{background:rgba(91,141,239,.14);color:var(--tb-active-text,#7fa7f0)}',
      '.fl-out{color:var(--tb-done-text,#81c784)}',
